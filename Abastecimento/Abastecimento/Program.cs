...
var dieselS08 = new DieselS08("Diesel S-8", 0);
dieselS08.AtualizarValor(550, DateTime.Now, "Diesel S-8");
dieselS08.AtualizarValor(780, DateTime.Now, "Aditivo 8");
dieselS08.ExecutarAjustes();
Console.WriteLine(dieselS08.EmitirRelatorio());
...
gas.AtualizarValor(222, DateTime.Now, "Manguiras");
gas.ExecutarAjustes();
